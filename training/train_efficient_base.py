...
@click.option('--out_dir', type=str, required=True, default="./stage_1_recon_model_data/full_data_base_model_eff-base_LORA") #
...
@click.option('--data_file_path', type=str, required=True, default="./processed_data_stage1/dataset_format/authorship_dataset_with_style_embeds_AnnaWegmann_Style-Embedding") #
...
def main(
    ...
    #     r=16,                  # Rank of 16 is ideal for capturing nuanced style
    #     lora_alpha=32,         # Scaling factor
    #     lora_dropout=0.1,
    #     target_modules=["q", "v", "k", "o"] # Targeting all attention matrices in T5
    # )
    # # Wrap the model
    # lora_state = True
    ...
    if MODEL_TO_MODEL_TYPE[model_name] == 't5' or 't5-small' or 't5-base':
