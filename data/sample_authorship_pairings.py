...
@click.command()
@click.option('--in_dir', type=click.Path(exists=True), default="./processed_data_stage1/split_files")
@click.option('--out_dir', type=click.Path(), default="./processed_data_stage2/authorship_pairings")
